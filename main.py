...
def save_to_firestore(post_data):
    try:
        ...
        post_data['created_at'] = datetime.now(kst)
...
def analyze_url(url: str):
    ...
    post_data = {"title": title, "summary": summary, "category": category, "tags": tags, "thumbnail": thumbnail, "url": url, "status": "ACTIVE", "isFavorite": False, "isPinned": False, "isReed": False, "isDeleted": False, "memo_text":""}
...
async def analyze_image(file: UploadFile = File(...)):
    try:
        ...
        post_data = {"title": "이미지 분석 결과", "summary": summary, "category": category, "tags": tags, "thumbnail": "", "url": "uploaded_file", "status": "ACTIVE", "isFavorite": False, "isPinned": False, "isReed": False, "isDeleted": False, "memo_text":""}
